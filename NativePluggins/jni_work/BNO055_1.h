...
const float ACCEL_SCALE_FACTOR = 1.0 / 100.0;
...
extern "C" std::vector<float> getAccelerometer(const char* device_path, int device_address);
extern "C" std::vector<float> getMagnetometer(const char* device_path, int device_address);
extern "C" std::vector<float> getGyroscope(const char* device_path, int device_address);
extern "C" std::vector<float> getEuler(const char* device_path, int device_address);
extern "C" std::vector<float> getQuaternion(const char* device_path, int device_address);
extern "C" std::vector<float> getLinearAccel(const char* device_path, int device_address);
extern "C" std::vector<float> getGravity(const char* device_path, int device_address);
extern "C" std::vector<int> getSystemStatus(const char* device_path, int device_address);
