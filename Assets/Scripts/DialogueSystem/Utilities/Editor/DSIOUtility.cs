...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        private static void SaveGroupToScriptableObject(DSGroup group, DSDialogueContainerSO dialogueContainer)
        {
            ...
            CreateFolder($"{containerFolderPath}/Groups/{group}", "Dialogues");

            DSDialogueGroupSO dialogueGroup = CreateAsset<DSDialogueGroupSO>($"{containerFolderPath}/Groups/{group}", groupName);
